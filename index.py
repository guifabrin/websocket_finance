...
from app.handlers.api.v1 import users_handler, posts_handler, auth_handler
...
def make_app():
    ...
    return tornado.web.Application([
        ...
        (r'/api/v1/posts/?(.*)?', posts_handler.PostsHandler,
         dict(repository=main_post_repository, session_repository=main_session_repository)),
