...
main_captcha_repository = BaseRepository(entity=Captha, notification_repository = main_notification_repository)

if __name__ == "__main__":
    Automated(main_transactions_repository, main_user_repository, main_invoice_repository,
              main_accounts_repository, main_captcha_repository).run(main_accounts_repository.get_by_id(83))